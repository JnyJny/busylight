...
class TestSpeed:
    ...
    def test_speed_enum_values(self) -> None:
    ...
    def test_speed_duty_cycle_property(self) -> None:
    ...
    def test_speed_enum_members(self) -> None:
    ...
    def test_speed_enum_iteration(self) -> None:
    ...
    def test_speed_string_representation(self) -> None:
    ...
    def test_speed_enum_by_name(self) -> None:
    ...
    def test_speed_enum_by_value(self) -> None:
