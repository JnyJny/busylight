...
@pytest.mark.parametrize(
    ...
    [
        ["/light/{light_id}/status", [200, 404]],
        ["/lights/status", [200, 404]],
        ["/light/{light_id}/on", [200, 404]],
        ["/light/{light_id}/on/{color}", [200, 404]],
        ["/lights/on", [200, 404]],
        ["/lights/on/{color}", [200, 404]],
        ...
        ["/lights/blink", [200, 404]],
        ["/lights/blink/{color}", [200, 404]],
        ["/lights/blink/{color}/{speed}", [200, 404]],
        ["/light/{light_id}/rainbow", [200, 404]],
        ["/lights/rainbow", [200, 404]],
        ["/light/{light_id}/fli", [200, 404]],
        ["/lights/fli", [200, 404]],
        ["/light/{light_id}/pulse", [200, 404]],
        ["/light/{light_id}/pulse/{color}", [200, 404]],
        ["/lights/pulse", [200, 404]],
        ["/lights/pulse/{color}", [200, 404]],
    ],
)
def test_all_routes(
    route,
