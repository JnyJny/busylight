...
class TestLightSelection:
    ...
    def test_apply_effect(self):
        ...
        lights[0].cancel_tasks.assert_called_once()
        lights[0].add_task.assert_called_once()
    ...
    def test_blink_with_color_tuple(self):
        lights = [MockLight("Test")]
        selection = LightSelection(lights)
        
        selection.blink((0, 255, 0), count=3, speed="fast")  # Green color
        lights[0].cancel_tasks.assert_called_once()
        lights[0].add_task.assert_called_once()
