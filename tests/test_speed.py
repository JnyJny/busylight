...
class TestSpeed:
    ...
    def test_speed_enum_values(self):
        """Should have correct speed enum integer values."""
        assert Speed.Slow.value == 1
        assert Speed.Medium.value == 2  
        assert Speed.Fast.value == 3
    ...
    def test_speed_comparison(self):
        ...
        assert Speed.Slow.value < Speed.Medium.value < Speed.Fast.value
    ...
    def test_speed_enum_by_value(self):
        ...
        assert Speed(1) == Speed.Slow
        assert Speed(2) == Speed.Medium
        assert Speed(3) == Speed.Fast